...
<html>
	<head>
		<title>商品一覧</title>
		<link href="/shoppingApp/css/shopping.css" rel="stylesheet" type="text/css" />
	</head>
	<body>
		...
		<form action="./BuyItemServlet_ans">
			...
			<input class="common_button" type="button" onclick="location.href='./shoppingApp/login.jsp'" value="戻る">
		</form>
	</body>
</html>