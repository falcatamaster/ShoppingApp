	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		if("ログイン".equals(btn)) {
			...
			if(bean != null) {
				...
				rd = request.getRequestDispatcher("./shoppingApp/loginNG_boot.jsp");
			}
			...
			response.sendRedirect("./shoppingApp/login_boot.jsp");
			...
			rd = request.getRequestDispatcher("./shoppingApp/history_boot.jsp");
			rd.forward(request, response);
		}
	}
