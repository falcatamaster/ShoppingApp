 ...
 * アカウント新規作成後のログイン機能.
 */
@WebServlet("/AccountRegisterServletShopping_ans")
...
//				rd = request.getRequestDispatcher("./shoppingApp/loginNG.jsp");
//			}
...
//			rd = request.getRequestDispatcher("./shoppingApp/history.jsp");
//			rd.forward(request, response);
//		}
	}
